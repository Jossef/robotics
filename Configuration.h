...
#define PARTICLE_MAGIC_NUMBER 0.9

#define PARTICLE_KILL_THRESHOLD 0.3
#define PARTICLE_BIRTH_THRESHOLD 0.7

#define PARTICLE_COUNT 100

#define PARTICLE_PROB_MOV_YAW 10
#define PARTICLE_PROB_MOV_DISTANCE 0.05
